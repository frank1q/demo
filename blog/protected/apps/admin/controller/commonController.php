...
class commonController extends baseController{
   ...
   //信息添加，编辑时获得模板选项
    protected function tempchoose($mark='index',$default='index'){
    	$choose = '<option selected="selected" value="news_content">news_content</option><option  value="news_index">news_index</option><option  value="news_sortindex">news_sortindex</option>';
        return $choose;
    }
